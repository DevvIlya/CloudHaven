...
urlpatterns = [
    ...
    path('file-page/', views.file_page, name='file_page'),
    path('main-page/', views.main_page, name='main_page'),
    path('not-found-page/', views.not_found_page, name='not_found_page'),
    path('storage-page/', views.storage_page, name='storage_page'),
]
